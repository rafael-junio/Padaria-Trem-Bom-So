...
public class PadariaTeste {
	...
	public static void main(String[] args) {
		...
		tremBao.cadastrarVendedor("AAA", "Rua 5 547", "173.002.900-00", "(11) 3300-0002", "0001", 1500f);
		
		tremBao.cadastrarVendedor("CCC", "Rua 5", "173.002.900-00", "(00) 0000-0002", "0001", 1500f);
