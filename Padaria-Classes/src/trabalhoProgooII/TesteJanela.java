...
public class TesteJanela {
	...
	private void initialize() {
		...
		//AQUI TEMOS QUE INICIAR OS 5 FUNCION�RIOS E OS 20 PRODUTOS INICIAIS
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(opProduto == 0 && continuarPerguntas) {
					...
					while(!continuarCadastro) {
						try {
							precoCompra = Float.parseFloat(JOptionPane.showInputDialog("Digite o pre�o de compra: "));
					...
					precoVenda = Float.parseFloat(JOptionPane.showInputDialog("Digite o pre�o de venda: "));
				...
				if (continuarPerguntas) {
					...
					if(opProduto == 0) {
						String codigo = JOptionPane.showInputDialog("Qual o c�digo do produto que voc� quer vender: ");
						if(estoque.venderProduto(Integer.parseInt(codigo), 11, 10, 2018, v1))
							JOptionPane.showMessageDialog(null, "Produto vendido!");
						else
							JOptionPane.showMessageDialog(null, "Produto n�o dipon�vel no estoque!");
						continuarPerguntas = false;
						
					}
				}
				if (continuarPerguntas) {
					opProduto = JOptionPane.showConfirmDialog(null, "Deseja informa��es");
					if (opProduto == 0) {
